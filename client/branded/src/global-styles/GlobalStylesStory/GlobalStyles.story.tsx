...
export const Forms: Story = () => (
    <>
        ...
        <Form onSubmit={preventDefault}>
            ...
            <div className="form-group">
                <Select label="Example select" id="example-select" className="custom-select">
        ...
        <Form>
            <fieldset disabled={true}>
                ...
                <div className="form-group">
                    <Select label="Disabled select menu" id="disabledSelect" className="custom-select" disabled={true}>
        ...
        <div className="d-flex">
            <fieldset>
                <div className="form-group">
                    ...
                    <Select id="" label="Small select" className="custom-select custom-select-sm mb-1">
